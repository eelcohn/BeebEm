...
#include "../components/z80a.h"					// Included for z80 object
#include "../components/ls374.h"				// Included for 74ls374 object (using a seperate object definition instead of just a local variable, so we can log reads and writes)
